...
masters_page_range = list(range(0, 1261, 10))
masters_souped_page = []
...
masters_csv_df = pd.DataFrame.from_dict(csv_data, orient='index',
                                        columns=["course_type",
                                                 "course_name",
                                                 "course_link",
                                                 "uni_name",
...
masters_csv_df.to_csv(r"../data/masters_csv_df.csv")
